...
public class CommonMethods extends PageInitializer {
   public static WebDriver driver;
    public  static void openBrowserAndLaunchApplication(){
        ...
        Logs.startTestCase("This is the beginning of our test case");
        Logs.info("Our test case is executing right now");
        Logs.warning("Our test case might have issues");
    }


    public static void closeBrowser(){
        Logs.info("The test case is about to finish");
        Logs.endTestCase("Test case is completed");
        driver.close();
    ...
    public static byte[] takeScreenshot(String imageName){
        ...
        //This captures a screenshot and stores it as a file in the sourceFile variable
