...
public class APIPayloadConstants {
    ...
    public static String createEmployeePayloadJson(){
        ...
        obj.put("emp_firstname","Dior");
        obj.put("emp_lastname","Novales");
        obj.put("emp_middle_name","M");
        obj.put("emp_gender","F");
        obj.put("emp_birthday","1989-09-11");
    ...
    public static String updateCreateEmployeePayloadJson(){
        JSONObject obj = new JSONObject();
        obj.put("employee_id","57564A");
        obj.put("emp_firstname","Chanel");
        obj.put("emp_lastname","Novales");
        obj.put("emp_middle_name","M");
        obj.put("emp_gender","F");
        obj.put("emp_birthday","2023-09-11");
